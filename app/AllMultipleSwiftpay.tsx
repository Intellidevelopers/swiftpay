    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.addButtonContainer}>
            <TouchableOpacity style={styles.addButton} onPress={() => router.push('/MultipleSwiftpayTransfer')}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.users}>
            <Image source={require('../assets/icons/user1.png')} style={styles.user} />
            <View>
                <Text style={styles.name}>Jane Doe</Text>
                <Text style={styles.account}>@Getpaid10</Text>
            </View>
        ...
        <View style={styles.users}>
            <Image source={require('../assets/icons/user3.png')} style={styles.user} />
            <View>
                <Text style={styles.name}>Michael Smith</Text>
                <Text style={styles.account}>@micheal20</Text>
            </View>
            <View style={styles.status}>
                <Text style={styles.statusText}>Added</Text>
                <AntDesign name='closecircle' color={'red'} size={20}/>
        ...
        <View style={styles.users}>
            <Image source={require('../assets/icons/user2.png')} style={styles.user} />
            <View>
                <Text style={styles.name}>Adeagbo Josiah</Text>
                <Text style={styles.account}>@josiah1</Text>
            </View>
            <View style={styles.status}>
                <Text style={styles.statusText}>Added</Text>
                <AntDesign name='closecircle' color={'red'} size={20}/>
        ...
        <TouchableOpacity style={styles.nextButton} onPress={() => router.push('/MultipleSwiftpaySummary')}>
