    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.methodList}>
          ...
          <Text style={styles.methodHead}></Text>
          <Text style={styles.methodHead}>International Deposit Method</Text>

          <TouchableOpacity style={styles.methodItem}>
            <View style={styles.flex}>
              <Image source={require('../assets/icons/coinbase.png')} style={styles.bankImage} />
              <Text style={styles.methodName}>Coinbase Commence</Text>
            </View>
            <AntDesign name='right' size={18} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.methodItem}>
            <View style={styles.flex}>
              <Image source={require('../assets/icons/bitpay.png')} style={styles.bankImage} />
              <Text style={styles.methodName}>BitPay</Text>
            </View>
            <AntDesign name='right' size={18} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.methodItem}>
            <View style={styles.flex}>
              <Image source={require('../assets/icons/payoneer.png')} style={styles.bankImage} />
              <Text style={styles.methodName}>Payoneer</Text>
            </View>
            <AntDesign name='right' size={18} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.methodItem}>
