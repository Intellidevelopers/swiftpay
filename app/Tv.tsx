    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        {selectedTab === 'TV' ? (
          ...
          <>
            <View style={styles.selectionRow}>
              <Text style={styles.selectionLabel}>Select Internet Provider</Text>
              <TouchableOpacity onPress={() => setProviderModalVisible(true)} style={styles.dropDown}>
                {selectedProvider ? (
                  <View style={styles.providerContainer}>
...
const styles = StyleSheet.create({
  ...
  dropDown: { borderWidth: 2, borderColor: '#ddd', borderRadius: 5, padding: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
