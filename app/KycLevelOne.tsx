...
const KycLevelOne = () => {
  ...
  const pickImage = async (setImage: (imageUri: string | null) => void) => {
  ...
  const takePicture = async (setImage: (imageUri: string | null) => void) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.camera} onPress={() => takePicture(setFrontImage)}>
        ...
        <TouchableOpacity style={styles.camera} onPress={() => takePicture(setBackImage)}>
            <AntDesign name='camerao' size={30} color={'#fff'} />
        </TouchableOpacity>
