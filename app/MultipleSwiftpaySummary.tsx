  ...
  return (
    <View style={styles.container}>
     <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Transfer to Multiple Swiftpay Accounts</Text>
      </View>
      {/* Total Amount */}
      ...
      <View style={styles.card}>
        <View style={styles.userInfo}>
          ...
          <Text style={styles.bankInfo}>Swiftpay user & 12 others</Text>
          </View>
        </View>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.value}>@Gtreatam67</Text>
        </View>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.value}>4,860.00 NGN</Text>
        </View>
      </View>
      ...
      <Text style={styles.desc}>Your transfer to multiple swiftpay accounts for N4,890.00 is successful</Text>
