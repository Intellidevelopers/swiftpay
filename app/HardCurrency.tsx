...
const HardCurrency = () => {
  return (
    <View style={styles.container}>
      <Image source={require('../assets/payments/6.png')} style={styles.image} />
      <Text style={styles.text}>Hard Currency</Text>
      <View style={styles.listContainer}>
        <View style={styles.iconContainer}>
          <Image source={require('../assets/icons/currency.png')} style={styles.icon} />
          <Text style={styles.listItem}>Save your money in hard currency or Gold</Text>
        </View>

        <View style={styles.iconContainer}>
          <Image source={require('../assets/icons/2.png')} style={styles.icon} />
          <Text style={styles.listItem}>Earn more in your local currency once the rate of the hard currency you saved your money in goes higher.</Text>
        </View>

        <View style={styles.iconContainer}>
          <Image source={require('../assets/icons/dolls.png')} style={styles.icon} />
