  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.row}>
          <TouchableOpacity style={styles.card} onPress={() => router.push('/AirtimeData')}>
            <Image source={require('../../assets/Bills/phone.png')} style={styles.icon} />
