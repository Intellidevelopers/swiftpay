...
const Abroad = () => {
  return (
    <View style={styles.container}>
      <Image source={require('../assets/payments/5.png')} style={styles.image} />
      <Text style={styles.text}>Send Money Abroad</Text>
      <View style={styles.listContainer}>
        <View style={styles.iconContainer}>
          <Image source={require('../assets/icons/1.png')} style={styles.icon} />
          <Text style={styles.listItem}>Send money Swiftly to your friends & family Abroad</Text>
        </View>

        <View style={styles.iconContainer}>
          <Image source={require('../assets/icons/2.png')} style={styles.icon} />
          <Text style={styles.listItem}>Send to their Foreign Bank accounts or Mobile money wallet.</Text>
        </View>
