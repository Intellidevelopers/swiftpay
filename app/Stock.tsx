...
const Stock = () => {
  return (
    <View style={styles.container}>
      <Image source={require('../assets/payments/2.png')} style={styles.image} />
      ...
      <View style={styles.listContainer}>
        ...
        <View style={styles.iconContainer}>
          ...
          <Text style={styles.listItem}>Watch your money grow according to the percentage increase on each asset.</Text>
        </View>
